...
<body>
  ...
  <div class="container col-sm-8" >
      ...
      <div class="form-group">
          <h2 class="form-signin-heading" style="text-align:center;">Enter the details</h2>
          <div class="row">
         ...
         <label for="fileToUpload" class="col-sm-2 control-label">Upload Syllabus</label>
          ...
          <button align="center" style="width:20%" class="btn btn-lg btn-primary btn-block col-sm-8" type="submit">Sign in</button>
        </div>
      </form>
